import { ContextoInfo } from "./Contexto";
import { useState } from "react";
import colombiana from '../assets/Image/profeColombia.jpg'
import francesa from '../assets/Image/profeFrancia.jpg'
import inglesa from '../assets/Image/profeFrancia.jpg'
...
export const ProviderPadre = ({children})=>{

  const [persona, setPersona] = useState(valores);

  return(
    <ContextoInfo.Provider value={{persona, setPersona}}>
      {children}
